                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('materias.edit', $materia) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">
                                Editar
                            </a>
                            @if ($materia->status === 'pendente')
                                <form method="POST" action="{{ route('materias.aprovar', $materia) }}">
                                    @csrf
                            ...
                            @endif
                            <form method="POST" action="{{ route('materias.destroy', $materia) }}" onsubmit="return confirm('Tem certeza que deseja excluir esta matéria?');">
                                @csrf
                                @method('DELETE')
