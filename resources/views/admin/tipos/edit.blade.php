                    ...
                    <form action="{{ route('tipos.update', $tipo) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="template" id="template" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('template', $tipo->template) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="descricao" id="descricao" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('descricao', $tipo->descricao) }}</textarea>
                        </div>

                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="ativo" name="ativo" type="checkbox" value="1" {{ old('ativo', $tipo->ativo) ? 'checked' : '' }}
